...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profile_userprofile', (
            ...
            ('idp', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('uhash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
    ...
    models = {
        ...
        'profile.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idp': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            ...
            'uhash': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
