...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ssh_sshkey', (
            ...
            ('lastverified', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('ssh', ['SSHKey'])

        # Adding M2M table for field assurance on 'SSHKey'
        db.create_table('ssh_sshkey_assurance', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sshkey', models.ForeignKey(orm['ssh.sshkey'], null=False)),
            ('assurance', models.ForeignKey(orm['assurance.assurance'], null=False))
        ))
        db.create_unique('ssh_sshkey_assurance', ['sshkey_id', 'assurance_id'])


    def backwards(self, orm):
        # Deleting model 'SSHKey'
        db.delete_table('ssh_sshkey')

        # Removing M2M table for field assurance on 'SSHKey'
        db.delete_table('ssh_sshkey_assurance')
    ...
    models = {
        ...
        'ssh.sshkey': {
            ...
            'assurance': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['assurance.Assurance']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.TextField', [], {}),
            'lastupdated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'lastverified': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
